...
def brain_region_dataset(path, time, region=None):
    feature = np.load(f"{path}/{time}_dataset/{time}_feature_collection_CARTBIND.npy")
...
feature_path = "/Volumes/NINET/CARTBIND_EEG_data/CARTBIND_UBC/New_Features"
...
resp_idx = [1, 2, 4, 5, 6, 7, 8, 13, 14, 16, 17, 20, 23, 25]
non_resp_idx = [0, 3, 9, 10, 11, 12, 15, 18, 19, 21, 22, 24, 26]
...
plt.scatter(np.mean(resp_x_T0,axis=0), np.mean(resp_y_T0, axis=0), label='T0', marker='o')
plt.scatter(np.mean(resp_x_T1,axis=0), np.mean(resp_y_T1, axis=0), label='T1', marker='o')
plt.scatter(np.mean(resp_x_T2,axis=0), np.mean(resp_y_T2,axis=0), label='T2', marker='o')
...
plt.title("Trend in Non-Responder Group")
plt.savefig("non_resp_trend_UBC.png", dpi=300)
...
plt.scatter(np.mean(resp_x_T0_2,axis=0), np.mean(resp_y_T0_2, axis=0), label='T0', marker='o')
plt.scatter(np.mean(resp_x_T1_2,axis=0), np.mean(resp_y_T1_2, axis=0), label='T1', marker='o')
plt.scatter(np.mean(resp_x_T2_2,axis=0), np.mean(resp_y_T2_2,axis=0), label='T2', marker='o')
...
plt.xlabel("PEn")
plt.ylabel("LMC (Statistical complexity")
plt.title("Trend in Responder Group")
plt.savefig("resp_trend_UBC.png", dpi=300)
plt.show()